...
import { WorkflowState } from './src/domains/systemOrchestrator/types';
...
async function runTests() {
  ...
  try {
    ...
    // Test 6: Validate all
    console.log('\n6. Testing validate-all');
    const validateAllResult = await systemOrchestrator.validateAll();
    console.log('✅ Validate-all result:', validateAllResult);
