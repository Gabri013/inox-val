...
|------|------|----|---------|
| TEMPLATE | Orçamento Padrão | TMPL-001 | 1.0.0 |
| PROCESS | Corte Laser | PROC-001 | 2.1.3 |
| MATERIAL | AÇO INOX 304 | MAT-001 | 1.2.0 |
| SETTING | Configurações de Preço | SET-001 | 3.0.1 |
| CALIBRATION_FACTOR | Fator de Calibração Laser | CAL-001 | 1.0.5 |

## Changelog
| Item Type | Item ID | Version Before | Version After | User ID | Timestamp | Reason | Details |
|-----------|---------|----------------|---------------|---------|-----------|--------|---------|
