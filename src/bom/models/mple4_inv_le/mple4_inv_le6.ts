/**
 * Modelo MPLE4_INV_LE6
 * Encosto Espelho Traseiro + Lateral Esq (6 pés)
 */
...
export function gerarBOM_MPLE4_INV_LE6(config: MesaConfig): BOMResult {
  ...
  // TAMPO COM ESPELHOS
  addChapaItem({
    desc: 'TAMPO COM ESPELHO TRASEIRO E LATERAL ESQUERDO',
    qtd: 1,
    w: r1(c + 180),
    h: r1(l + 180),
  ...
  return {
    modelo: 'MPLE4_INV_LE6',
    descricao: 'Encosto Espelho Traseiro + Lateral Esq (6 pés)',
